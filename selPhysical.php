...
';
 ...
 <div class="col-xs-2"><button class="btn btn-primary" id= "btnshowReports">Show</button></div>
 <div class="col-xs-2"><button class="btn btn-primary"  style="float:right; id= "btnPhysicalprint">Print</button></div>
 </div>';
