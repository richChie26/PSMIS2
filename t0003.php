       ...
       <div class="col-xs-4">
        ...
        <div class="form-group has-feedback">
          <div class="form-group"> 
           ...
           <select class="form-control" name ="mnuasset" id="mnuasset">
         ...
         <div class="col-xs-4">
             <div class="form-group">
             <div id="divmanual"></div>
           <button id="btnshowreceive" class="btn btn-primary" style="display:none" >Show</button>
               <!--  <div class='input-group date' id='datetimepicker1'>
                    <input type='date' id="dtpdate" name="dtpdate" class="form-control" />
