...
<div class= "row"> <div class="col-xs-12">
   Remarks on Approval : '.$remarks.'<br/>
<label></label>
</div></div>
...
<div class="row">
      <div class="col-xs-12">
          <div class="alert alert-info"> Are you sure you want to disapprove Supply Request by <?php echo $Requestedby; ?></div>
      </div>
...
<div class="row">
    <div class="col-xs-12">
        ...
        <button class="btn btn-primary btnyesdisapproved" id="<?php
        echo $yourid .'|'. $remarks;
