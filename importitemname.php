...
<body>
    <div class="container">
    	...
    	<div class="card">
    		<div class="card-header"><b>Select Excel File fro ITEM Name</b></div>
    		<div class="card-body">
    			
                <input type="file" id="excel_file" />

<button id="btnuploaditem" class="btn btn-primary" style="float: right;">Submit</button>
<br/>
    		</div>
    	</div>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                $(document).on("click","#btnuploadsssssss",function(e){
                    e.preventDefault();
...
$.ajax({
  ...
  success:function(response){
      // alert(response);
      if(response == 1){
        alert("Account Title Succesfully Uploaded");
        $("#A0008").trigger("click");        
