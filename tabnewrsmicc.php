...
<table style="width: 50%;margin-left: 15px;"> <tr><td>
      <div class="form-group">
          <select style="width:90%;" id="selrsmicc"class="form-control">
     ...
     <div class="form-group">
          <input type="text" name="txtsearchnewrsmic" id="txtsearchnewrsmic" class="form-control" placeholder="Search" style="width: 90%;">
        </div></td>
        <td style="padding: 0px;margin: 0px;"><button id="btnsearchrsmicc" class="btn btn-primary" >Search</button></td>
      </tr>
    </table>
...
<th>Date </th> 
         ...
         <tbody id="rsmidetails">
          <?php
        $sql = "SELECT `code` rsmicode,convert(`creationdate`,date) rsmiDate  FROM `t_rsmicode` order by id desc ";
