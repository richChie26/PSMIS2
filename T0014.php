...
<div class="col-xs-4">
  <div class="form-group">
    <div class="form-group has-feedback">
      <input type="text" class="form-control" placeholder="Responsibility Center" id="txtCenter" name="txtCenter"
        required="true" readonly="true" style="display:none">
      <span class="glyphicon glyphicon-bookmark form-control-feedback" style="display:none"></span>
...
<select class="form-control" id="selPhysical" >';
