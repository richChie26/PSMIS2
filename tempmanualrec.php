...
`decription` , `cha`, `serial`,amount,a.propertyno
...
left join m_accouttitle  z on x.`accounttitle` = z.id and z.isactive = 1 
          ...
          where `createdby` =  $uid and a.tag = 0  ";
...
echo '         <tr>
    <td>  '.$row['accounttitle'].'</td>
        ...
        <td> '.$row['amount'].'</td>
         ...
         <td><center><a href="#" class="btnremovemanual" id= "'.$row['id'].'|'.$row['item'].'"><span style="color:red;" class="glyphicon glyphicon-minus"  ></span></center></td> <tr> ';
}
    ?> 