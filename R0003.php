...
?>
 ...
 <form action="#" method="post" id="frmMenu">
  ...
  <div id="myalert"><div class="alert alert-info" > <strong>Information!</strong> Please fill-up the form correctly!  .</div>
  <button class="btn btn-primary" style="float: right;" id="btnprintpc">Print</button>
</div>
<div class="row">
       <div class="col-xs-4">
...
<div class="row">
       <div class="col-xs-4">
        <div  class="form-group">
        <input type="text" name="txtproperty3" id="txtproperty3" class="form-control" readonly="true" placeholder="Property Number">
          </div>
        </div>
        <div class="col-xs-4">
        <div  class="form-group">
        <input type="text" name="txtsimeitem3" id="txtsimeitem3" class="form-control" readonly="true" placeholder="Item Name">
          </div>
        </div>
       <div class="col-xs-4">
        <div  class="form-group">
