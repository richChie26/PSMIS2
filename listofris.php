...
x.id,z.accounttitle,
itemname,`stockno`,`description`,x.item
,za.units
FROM `m_materials` x 
...
// echo $sql;
echo '
<div class= "row" style="margin-left:10px;"> <div class="col-xs-12">
   RIS Code : '.$myid.'<br/>

</div></div>
<div class= "row" style="margin-left:10px;"> <div class="col-xs-6">
   Purpose : '.$purpose.'<br/>
 
</div>

<div class= "row" style="margin-left:8px;"> <div class="col-xs-12">
   Requested by : '.$Requestedby.'<br/>

</div></div>
<div class= "row" style="margin-left:8px;"> <div class="col-xs-12">
   Date request : '.$DateRequest.'<br/>
<label></label>
</div></div>
