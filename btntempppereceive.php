...
$txtchasis = $_GET['txtchasis'];
 ...
 $sqlinsert = "insert into  `t_tempsemipee` (`itemid`, `amount`, `description`, `serial`, `createdby`, `tag`,dateaquire,chano )values($editbtnid , $txtamount, '$txtdesc', '$txtserial', $uid, 0,'$dtpdateaquired','$txtchasis')";
