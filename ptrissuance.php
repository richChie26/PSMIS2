...
<option value="OTHERS">OTHER (SPECIFY)</option>
      ...
      <div class="col-xs-4">
        <div class="form-group">
            <input type="text" name="txtothers" id="txtothers" class="form-control" placeholder="Specify if Others" />
        </div>
  </div>     
</div>
<div class="row">
...
<br/>
 ...
 <ul class="nav nav-tabs responsive-tabs" >
    ...
    <li><a data-toggle="tab" href="#menu1" id="tabptr">List of Semi Expendable Transfer</a></li>
