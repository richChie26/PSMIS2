...
<input type="hidden" name="myhiddentag" id="myhiddentag" value="2">
<div class="panel panel-primary" id="supplannel">
   <div class="panel-heading">List of Transfered Semi Expendables</div>
  <div class="panel-body" >
    <!-- ============== -->
 <ul class="nav nav-tabs responsive-tabs" >
    <li class="active" ><a data-toggle="tab" href="#home"><span class="glyphicon glyphicon-th-list" style="background-color: #337ab7"></span> &nbsp;&nbsp;Semi Expendable to Transfer</a></li>
    <li><a data-toggle="tab" href="#menu1" id="tabptrres">List of Received Semi Expendable </a></li>
...
f left join (SELECT a.id delitemid, accounttitle,item,yearoflife,
 ...
 where y.typeofasset = 2 and x.isactive =1 ) b on a.`itemid` = b.id where a.isactive = 1 ) b 
 on f.`propertyno` = b.propertyno
where f.ptrcode = '$PARNO'  and tag = 2 and ifnull(f.status,'') = ''
";
