...
<div class="panel panel-primary">
   <div class="panel-heading">INVENTORY CUSTODIAN SLIP (ICS)</div>
...
<div class="row">
       <div class="col-xs-4">
        ...
        <input type="text" name="txtsimeitem" id="txtsimeitem" class="form-control" readonly="true" placeholder="Item:">
        	</div>
        </div>
       <div class="col-xs-4">
       	<div  class="form-group">
...
<div class="row">
       <div class="col-xs-4">
       	<div  class="form-group">
       <input type="text" name="txtissuedposition" id="txtissuedposition" class="form-control" readonly="true" placeholder="POSITION/OFFICE:" value="<?php echo $Position; ?>">
        	</div>
  </div>   
</div>
...
<br/>
 ...
 <ul class="nav nav-tabs responsive-tabs" >
    <li class="active" ><a data-toggle="tab" href="#home"><span class="glyphicon glyphicon-th-list" style="background-color: #337ab7"></span> &nbsp;&nbsp;Semi Expendable to Issue</a></li>
    <li><a data-toggle="tab" href="#menu1" id="newsemitab">List of Semi Expendable Issued</a></li>
...
<div class="row">
  <div class="col-xs-6">
      <button class="btn btn-primary" id ="btntempsemiissuance"><span class="glyphicon glyphicon-plus"></span>&nbsp;Add</button>
  </div>
    <div class="col-xs-4">
     
  </div>
    <div class="col-xs-2">
      <button class="btn btn-primary" id="btnsavesemiissuance" style="float:right"><span class="glyphicon glyphicon-floppy-disk"></span>&nbsp;Submit</button>
  </div>  
</div>
<br/>
      <div class="row">
